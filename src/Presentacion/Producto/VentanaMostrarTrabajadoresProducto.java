...
public class VentanaMostrarTrabajadoresProducto extends JDialog implements ActionListener{
	...
	public VentanaMostrarTrabajadoresProducto() {
	...
	void iniciarventana(){
		...
		this.setLayout(null);
		this.setTitle("Mostrar Trabajadores de un Producto");
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (botonPulsado == botonAceptar) {
			...
			Controller.getInstance().action(aux, Evento.MOSTRAR_TRABAJADORES_PRODUCTO);	//else Controller.getInstance().action("No has introducido datos", Evento.DATOS_INCORRECTOS_PRODUCTO);
