...
public class GUIHospital extends JPanel implements ActionListener, IGUI {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (botonPulsado == OperationsPanel.getAltaBoton()) {
			VentanaCrearHospital addSala = new VentanaCrearHospital();
		}else if (botonPulsado == OperationsPanel.getBajaBoton()) {
			VentanaBajaHospital bajaSala = new VentanaBajaHospital();
		}else if (botonPulsado == OperationsPanel.getModificarBoton()) {
			VentanaModificarHospital modSala = new VentanaModificarHospital();
		}
